...
*/
    ...
    <a class="btn btn-lg btn-primary" 
   	href="/board/list?pageNo=${sessionScope.pageNo}&searchField=${sessionScope.searchField}&searchWord=${sessionScope.searchWord}"
   		...
   		리스트 &raquo;
   	--%>
		<a class="btn btn-lg btn-primary" href="#" id="btnList" role="button">
			리스트 &raquo; </a>
	</div>
	<p></p>
	<!-- 상세보기 -->
	...
	<input type="text" name="searchWord" id="searchWord" value="${sessionScope.searchWord }">
	 --%>
			...
			<input type="text" name="searchField" id="searchField"
				value="${param.searchField }"> <input type="text"
				name="searchWord" id="searchWord" value="${param.searchWord }">
	...
	--%>
			...
			<div class="mb-3">
				<label for="title" class="form-label">제목</label> <input name="title"
					id="title" type="text" readonly class="form-control"
					value='${board.title}'>
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				<label for="writer" class="form-label">작성자</label> <input
					type="text" readonly class="form-control" readonly id="writer"
	...
	<div class="input-group">
		<span class="input-group-text">답글작성</span> <input type="text"
			name="page" id="page" value="1"> <input type="text"
			aria-label="First name" class="form-control" id="reply"> <input
			type="button" id="btnReplyWrite" aria-label="Last name"
			class="input-group-text" value="등록하기">
	</div>
